  ...
  return (
    <div className="w-full">
      ...
      >
        <div className="mb-8">
          <div
            className="relative mb-2 aspect-[25/28] overflow-hidden rounded-md
          "
          >
        ...
        <p className=" border-opacity-10 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-10 dark:text-white">
          “{content}
        </p>
      </div>
    </div>
