...
const OfferList = ({
  ...
  return (
    <div className="mb-3 flex items-center">
      <span className="mr-3 flex h-[18px] w-full max-w-[18px] items-center justify-center rounded-full text-primary" style={{ backgroundColor: "rgba(var(--color-primary-rgb), 0.1)" }}>
